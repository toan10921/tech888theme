	...
	<?php else : ?>
		<div class="variations">
			...
			?>
				...
				<?php echo end( $attribute_keys ) === $attribute_name ? apply_filters( 'woocommerce_reset_variations_link', '<a class="reset_variations" href="#">' . esc_html__( 'Clear', '7upframework' ) . '</a>' ) : '';?>
			<?php endforeach;?>
		</div>
