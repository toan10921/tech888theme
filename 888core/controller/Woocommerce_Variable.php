...
if(!class_exists('S7upf_Woocommerce_Attributes')){
    class S7upf_Woocommerce_Attributes{
        ...
        static function tech888fproduct_option_terms_attribute( $taxonomy, $index ) {
            ...
            <select multiple="multiple" data-placeholder="<?php esc_attr_e( 'Select terms', 'ripara' ); ?>" class="multiselect attribute_values wc-enhanced-select" name="attribute_values[<?php echo esc_attr($index); ?>][]">
                <?php
            ...
            <button class="button plus select_all_attributes"><?php esc_html_e( 'Select all', 'ripara' ); ?></button>
            <button class="button minus select_no_attributes"><?php esc_html_e( 'Select none', 'ripara' ); ?></button>
            <button class="button fr plus tawcvs_add_new_attribute" data-type="<?php echo esc_attr($taxonomy->attribute_type); ?>"><?php esc_html_e( 'Add new', 'ripara' ); ?></button>
